( function ( wp ) {
	...
	registerBlockType( 'centaur-scores/competition-result', {
		edit: function ( props ) {
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{ title: __( 'Competition settings', 'centaur-scores' ) },
						el( TextControl, {
						...
						el( TextControl, {
							label: __( 'Competition ID', 'centaur-scores' ),
							value: attributes.competitionId,
							onChange: function ( value ) {
								setAttributes( { competitionId: value } );
							},
						} ),
						el( SelectControl, {
				...
				el( ServerSideRender, {
					block: 'centaur-scores/competition-result',
