export type View = 'home' | 'matches' | 'match' | 'competitions' | 'participants' | 'categories' | 'templates' | 'accounts' | 'account' | 'profile' | 'tenants' | 'tenant'
...
export type ManagementView = 'participants' | 'categories' | 'templates'
export const managementSections: ManagementView[] = ['participants', 'categories', 'templates']
